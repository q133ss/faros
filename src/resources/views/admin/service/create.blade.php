...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Добавить услугу</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{route('admin.service.store')}}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="list_name" name="name" value="{{ old('name') }}">
                </div>
                <div class="form-group">
                    <label for="post_name">Подзаголовок</label>
                    <input type="text" class="form-control" id="post_name" name="subtitle" value="{{ old('subtitle') }}">
                </div>

                <div class="form-group">
                    <label for="text">Короткое описание</label>
                    <textarea class="form-control d-none" id="text" name="short_description" rows="3">{{ old('short_description') }}</textarea>
