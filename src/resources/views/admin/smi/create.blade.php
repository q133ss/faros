...
@section('title', 'Добавить СМИ')
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Добавить СМИ</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{route('admin.smi.store')}}" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="list_title" name="list_title" value="{{ old('list_title') }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="type" id="type">
                        ...
                        <option value="yellow_bg" @if(old('type') == 'yellow_bg') selected @endif>Желтый фон</option>
                        <option value="gray_bg" @if(old('type') == 'gray_bg') selected @endif>Серый фон</option>
                    </select>
                </div>
