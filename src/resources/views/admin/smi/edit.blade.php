...
@section('content')
    <div class="card">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{route('admin.smi.update', $post->id)}}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            @if ($errors->any())
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="name">Заголовок в списке*</label>
                    <input type="text" class="form-control" id="list_title" name="list_title" value="{{ $post->list_title }}">
                </div>

                <div class="form-group">
                    <label for="name">Заголовок на детальной странице*</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="source" name="source" value="{{ $post->source }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="type" id="type">
                        ...
                        <option value="yellow_bg" @if($post->type == 'yellow_bg') selected @endif>Желтый фон</option>
                        <option value="gray_bg" @if($post->type == 'gray_bg') selected @endif>Серый фон</option>
                    </select>
                </div>
