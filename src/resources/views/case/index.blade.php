...
@section('content')
    ...
    <div class="homeMiniBlocks allcases homeMiniBlocks_allcases">
        ...
        >
            <div class="miniBlock__layer">
                <span class="miniBlock__layer__pic parallax">
                        <img src="{{$case->list_img}}" loading="lazy" title="Faros Media" alt="{{$case->list_name}}" data-depth="0.6">
                </span>
            </div>
            ...
            <div class="miniBlock__wrap">
                <span class="miniBlock__wrap__pic">
                    @if($case->logo != null)
                        <img src="{{$case->logo}}" loading="lazy" title="Faros Media" alt="{{$case->list_name}}">
                    @endif
                </span>
        ...
        >
            <div class="miniBlock__layer">
                <span class="miniBlock__layer__pic parallax">
                        <img src="{{$case->list_img}}" loading="lazy" title="Faros Media" data-depth="0.6" alt="Faros Media">
                </span>
            </div>
            ...
            <div class="miniBlock__wrap">
                <span class="miniBlock__wrap__pic">
                    @if($case->logo != null)
                        <img src="{{$case->logo}}" loading="lazy" title="Faros Media" alt="Faros media">
                    @endif
                </span>
                <a href="{{route('case.show', $case->slug)}}" style="color: {{$case->text_color}}!important;" class="miniBlock__wrap__tit _colorWhite"
                >{{$case->list_name}}</a>
    ...
    <div class="projBlock _bgYellow">
        ...
        <picture class="projBlock__bg">
            <img src="../upload/resize_cache/webp/iblock/4cf/oeuo0yblidd5bcd9rirjtqfidcq9kn5e/projbg.webp" loading="lazy" alt="Faros Media">
        </picture>
    ...
    <div class="homeMiniBlocksLast other-cases" title="10" style="grid-template-columns: repeat(10, max-content);">
        ...
        >
            <div class="miniBlock__layer">
                <span class="miniBlock__layer__pic parallax">
                        <img src="{{$case->list_img}}" loading="lazy" title="Faros Media" alt="Faros Media" data-depth="0.6">
                </span>
            </div>
    ...
    <div class="formBlockWrap _bgLightGray" id="form">
        ...
        <div class="formSoc">
            ...
            <a  href="https://www.facebook.com/Faros.Media"  class="formSoc__item" rel="nofollow">
                <svg viewBox="0 0 48 48" class="contacts__data__links__soc__link__img">
                    <circle cx="24" cy="24" r="23.5" stroke="#EAEAEA" fill="rgba(26,26,26, 0)"/>
            ...
            <a  href="https://instagram.com/farosmedia"  class="formSoc__item" rel="nofollow">
                <svg viewBox="0 0 48 48" class="contacts__data__links__soc__link__img">
                    <circle cx="24" cy="24" r="23.5" stroke="#EAEAEA" fill="rgba(26,26,26, 0)"/>
                    <g clip-path="url(#clip0)">
    ...
    <div class="fullHeightMinWidth fullHeightMinWidth_thanks" style="display: none;">
        <img src="../images/min/home/thanks.svg" class="fullHeightMinWidth__thanks-img" loading="lazy" alt="Faros Media">
