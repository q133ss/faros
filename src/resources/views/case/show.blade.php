...
<head>
    ...
    <link rel="stylesheet" href="http://faros.media/local/templates/faros/css/styles.min.css?v=66">
...
<script src="http://faros.media/local/templates/faros/js/scripts.min.js?v=11"></script>
