<header class="header" id="header">
    <div class="header__dt">
        <a href="{{route('index')}}" class="header__logoWrap">
            <img src="/images/min/logo.svg" loading="lazy" alt="Faros media" class="header__logoWrap__logo">
            <img src="/images/min/logourl.svg" loading="lazy" alt="Faros media" class="header__logoWrap__logo-hover">
        </a>
        ...
        <nav class="header__menu hide-scroll">
                ...
                <a href="{{route('case.index')}}" class="header__menu__item">
                    <div class="header__menu__item__icoWrap">
                        <img loading="lazy" src="/images/min/icons/keyses.svg" alt="Faros media" class="header__menu__item__ico">
                    </div>
                    <span class="header__menu__item__name">Кейсы</span>
                </a>
                <a href="{{route('team.index')}}" class="header__menu__item">
                    <div class="header__menu__item__icoWrap">
                        <img loading="lazy" src="/images/min/icons/teams.svg" alt="Faros media" class="header__menu__item__ico">
                    </div>
                    <span class="header__menu__item__name">Команда</span>
                </a>
                <a href="{{route('articles.index')}}" class="header__menu__item">
                    <div class="header__menu__item__icoWrap">
                        <img loading="lazy" src="/images/min/icons/blogs.svg" alt="Faros media" class="header__menu__item__ico">
                    </div>
                    <span class="header__menu__item__name">Статьи</span>
                </a>
                <a href="{{route('video.index')}}" class="header__menu__item">
                    <div class="header__menu__item__icoWrap">
                        <img loading="lazy" src="/images/min/icons/media.svg" alt="Faros media" class="header__menu__item__ico">
                    </div>
                    <span class="header__menu__item__name">Мы в эфире</span>
                </a>
                <a href="{{route('smi.index')}}" class="header__menu__item">
                    <div class="header__menu__item__icoWrap">
                        <img loading="lazy" src="/images/min/icons/videos.svg" alt="Faros media" class="header__menu__item__ico">
                    </div>
                    <span class="header__menu__item__name">СМИ</span>
                </a>
                <a href="{{route('pay.index')}}" class="header__menu__item">
                    <div class="header__menu__item__icoWrap">
                        <img loading="lazy" src="/images/min/icons/onlinepay.svg" alt="Faros media" class="header__menu__item__ico">
                    </div>
