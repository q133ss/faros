...
@section('content')
    ...
    <div class="allServiceMiniBlocks">
        ...
        <a href="{{route('service.show', 'orm')}}" class="miniBlock _bgRed1 scene addY"
        >
        ...
        <!--1/2 height, min width, home miniBlock START-->
        <a href="{{route('service.show', 'smm')}}" class="miniBlock _bgRed1 scene addY"
        ...
        <!--1/2 height, min width, home miniBlock END-->
        <!--1/2 height, min width, home miniBlock START-->
        <a href="{{route('service.show', 'pr')}}" class="miniBlock _bgRed1 scene addY"
        ...
        <!--1/2 height, min width, home miniBlock END-->
        <!--1/2 height, min width, home miniBlock START-->
        <a href="{{route('service.show', 'marketing')}}" class="miniBlock _bgRed1 scene addY"
