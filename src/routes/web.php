...
# в кейсах в админке нет поля для самого текста+
# еще у кейсов было бы важно менять id - чтоб можно было порядок поменять если что+
# к видео важно добавить текст который будет под ним отображаться+
# в конце статей вылезает постоянно длинное пустое поле после подвала+
# критические ошибки разметки всплыли
# шрифты как я писала выше - поехали сильно
# РЕДАКТОР ИЗ WORDPRESS
# и отсюда страницы тоже странно выглядят - https://faros.media/service/smm
